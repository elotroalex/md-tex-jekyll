...
\startsetups[text a]
  SX:A{\bf\getvariable{article}{issue}}~[~\getvariable{article}{date}~]
\stopsetups
...
Small~Axe:~Archipelagos~\bullet~\getvariable{article}{date}~\bullet~DOI~\getvariable{article}{DOI}~\copyright~Small~Axe, Inc.\hfill
}
