...
\setupexternalfigures[directory={images/},width=\textwidth]
...
\setupfootnotes[style={\setupinterlinespace[9pt]\setupalign[verytolerant,stretch]}]
...
\setuppagenumbering[alternative=doublesided, location={header, margin}, style={\setupbodyfont[7.5pt]}]

\setupheadertexts[]
\setupheader[margin][state=normal, style={\setupbodyfont[17.5pt]}]
\setupheadertexts[][\setups{text a}][\setups{text b}][]

\startsetups[text a]
  SX{\bf\getvariable{article}{issue}}~[~\getvariable{article}{date}~]
\stopsetups
