...
\setupexternalfigures[directory={images}, maxwidth=\textwidth, maxheight=.5\textheight, scale=2000]
...
\setuppagenumbering[alternative=doublesided, location={header, margin}, style={\setupbodyfont[9pt]}]
