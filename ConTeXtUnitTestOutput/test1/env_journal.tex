...
\startsetups[text a]
  ...
  \hfill
  \llap{\inframed[autowidth=force, height=11pt, width=9pt, align=middle]{SX}~\getvariable{article}{issue}~\color[gray]{\bullet}~\getvariable{article}{date}~\color[gray]{\bullet}~\getvariable{article}{shortauthor}~\color[gray]{\|}~\pagenumber}
\stopsetups
