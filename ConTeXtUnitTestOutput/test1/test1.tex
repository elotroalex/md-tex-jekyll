...
\startblockquote
\definesymbol[bigsquare][]\setupitemize[symbol={}]

\startitemize[packed]
\item
  rather bear those ills we had,\crlf
\item
  \color[red]{Than fly to others, that we knew not of. }
  \startitemize[packed]
  \item
...
\item
  ...
  \startitemize[packed]
  \item
    \hspace[2]to compel some spaces 
  \item
    \hspace[5]though this is at the same ul level. 
  \stopitemize
\item
  \hspace[3]and this is back 
\item
  because poets.
\item
  base line
\item
  \hspace[1]base line indent 1 
\item
  \hspace[2]base line indent 2 
\item
  \hspace[3]base line indent 3 
\item
  \hspace[4]base line indent 4
  \startitemize[packed]
  \item
    indented line
    \startitemize[packed]
